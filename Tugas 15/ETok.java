...
public class ETok extends Toko  {
  ...
  private static ETok Zha = new ETok();
  ...
  ETok() {
    ...
    /*
    super.nama = "Zha";
    super.alamat = "https://www.Zha.com/";
    super.pemilik = "Curut";
    super.kredit = true;
    super.status = 'A';
    */
  ...
  public void set_toko() {
    Input.nextLine();
    System.out.print("Nama Toko         : ");Zha.nama = Input.nextLine();
    System.out.print("Alamat Toko       : ");Zha.alamat = Input.nextLine();
    System.out.print("Pemilik Toko      : ");Zha.pemilik = Input.nextLine();
    System.out.print("Pembayaran Kredit : ");Zha.kredit = Input.nextBoolean();
    System.out.print("Status Toko       : ");Zha.status = Input.next().charAt(0);
  }
  ...
  public void menu_belanja(int jumlah_transaksi, int max_barang) { //menu belanja, method mandiri
    ...
    int uang_dibayarkan, total_biaya = 0, sum_harga_barang = 0;
	    ...
	    do {
	      ...
	      while (!Zha.barang_exist(kode_barang, max_barang)) {
  ...
  public void menu_toko() { //menu toko, method mandiri
    ...
    do {
      ...
      switch (menu) {
        case 0 : exit = true; break;
        case 1 : Zha.get_toko(); break;
        case 2 : Zha.set_toko(); break;
        default : break;
      }
  ...
  public void menu_barang(int max) { //menu barang, method mandiri
    ...
    do {
      ...
      switch (menu) {
        case 0 : exit = true; break;
        case 1 : Zha.get_all_barang(max); break;
        case 2 : if (barang_available(max)) {
                 ...
                 break;
        case 3 : Zha.counter_barang = Zha.add_barang(max);
                 max = Zha.counter_barang;
                 break;
				default : break;
      }
  ...
  public static void main(String[] args) { //program utama
    ...
    boolean exit = false;
		...
		Object barang_segar = Me.new_obj(new Barang[5]);
		//barang_segar[0].setBarang("Ikan Salmon", "Kg", 50, 75000);
		//Me.print(barang_segar[0].getNama + " /" + barang_segar[0].getSatuan());
    ...
    do {
      ...
      switch (menu) {
        case 0 : exit = true; break;
        case 1 : Zha.menu_toko(); break;
        case 2 : Zha.menu_barang(Zha.counter_barang); break;
        case 3 : Zha.menu_konsumen(); break;
        case 4 : if (Zha.barang_available(Zha.counter_barang)) {
				        	 trx++; Zha.menu_belanja(trx, Zha.counter_barang);
				         }
				         else {
				         	 Catcher.message("NOTEXIST");Catcher.message("ADDDATA");
				        }
         				 break;
        case 5 : Zha.tentang(); break;
        default : break;
      }
