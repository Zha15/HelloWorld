...
public class ETok extends Toko {
  ...
  public static ETok Zha = new ETok();
  ...
  public static void menu_barang(int max) { //menu barang, method mandiri
    ...
    do {
      ...
      switch (menu) {
        ...
        case 1 : Zha.get_all_barang(Zha.counter); break;
  ...
  public static void main(String[] args) { //program utama
    ...
    do {
      ...
      switch (menu) {
        ...
        case 3 : Zha.menu_barang(Zha.counter); break;
        case 4 : Zha.counter = Zha.add_barang(Zha.counter); break;
        case 5 : trx++; belanja_tunai(trx); break;
        case 6 : Zha.tentang(); break;
        default : break;
      }
