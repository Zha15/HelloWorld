...
public class ETok extends Toko {
  ...
  public void menu_belanja(int jumlah_transaksi, int max_barang) { //menu belanja, method mandiri
    ...
    int uang_dibayarkan, total_biaya = 0, sum_harga_barang = 0;
	    ...
	    do {
	      ...
	      while (!Curut.barangExist(kode_barang, max_barang)) {
    ...
    do {
      ...
      switch (menu) {
        ...
        case 2 : if (barangAvailable(max)) {
                 ...
                 break;
        case 3 : Curut.counter = Curut.add_barang(max);
                 max = Curut.counter;
                 break;
				default : break;
      }
  ...
  public static void main(String[] args) { //program utama
    ...
    byte menu;
    boolean exit = false;
    strSys.cetak("Uji coba penggunaan kelas generik.\n");
    ...
    do {
      ...
      switch (menu) {
        ...
        case 2 : Curut.menu_barang(Curut.counter); break;
        case 3 : Curut.menu_konsumen(); break;
        case 4 : if (Curut.barangAvailable(Curut.counter)) {
				        	 trx++; Curut.menu_belanja(trx, Curut.counter);
				         }
				         else {
				         	 Catcher.Message("NOTEXIST");Catcher.Message("ADDDATA");
				        }
