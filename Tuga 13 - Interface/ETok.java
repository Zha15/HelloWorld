  ...
  public void menu_belanja(int jumlah_transaksi, int max_barang) { //menu belanja, method mandiri
    ...
    int uang_dibayarkan, total_biaya = 0, sum_harga_barang = 0;
	    ...
	    do {
	      ...
	      while (!Zha.barangExist(kode_barang, max_barang)) {
    ...
    do {
      ...
      switch (menu) {
        ...
        case 2 : if (barangAvailable(max)) {
                 ...
                 break;
        case 3 : Zha.counter = Zha.add_barang(max);
                 max = Zha.counter;
                 break;
				default : break;
      }
  ...
  public static void main(String[] args) { //program utama
    ...
    do {
      ...
      switch (menu) {
        ...
        case 2 : Zha.menu_barang(Zha.counter); break;
        case 3 : Zha.menu_konsumen(); break;
        case 4 : if (Zha.barangAvailable(Zha.counter)) {
				        	 trx++; Zha.menu_belanja(trx, Zha.counter);
				         }
				         else {
				         	 Catcher.Message("NOTEXIST");Catcher.Message("ADDDATA");
				        }
