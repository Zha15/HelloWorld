...
public class ETok extends Toko  {
  ...
  private static ETok Curut = new ETok();
  ...
  public void set_toko() {
    Input.nextLine();
    System.out.print("Nama Toko         : ");Curut.nama = Input.nextLine();
    System.out.print("Alamat Toko       : ");Curut.alamat = Input.nextLine();
    System.out.print("Pemilik Toko      : ");Curut.pemilik = Input.nextLine();
    System.out.print("Pembayaran Kredit : ");Curut.kredit = Input.nextBoolean();
    System.out.print("Status Toko       : ");Curut.status = Input.next().charAt(0);
  }
  ...
  public void menu_belanja(int jumlah_transaksi, int max_barang) { //menu belanja, method mandiri
    ...
    int uang_dibayarkan, total_biaya = 0, sum_harga_barang = 0;
	    ...
	    do {
	      ...
	      while (!Curut.barang_exist(kode_barang, max_barang)) {
  ...
  public void menu_toko() { //menu toko, method mandiri
    ...
    do {
      ...
      switch (menu) {
        case 0 : exit = true; break;
        case 1 : Curut.get_toko(); break;
        case 2 : Curut.set_toko(); break;
        default : break;
      }
  ...
  public void menu_barang(int max) { //menu barang, method mandiri
    ...
    do {
      ...
      switch (menu) {
        case 0 : exit = true; break;
        case 1 : Curut.get_all_barang(max); break;
        case 2 : if (barang_available(max)) {
                    ...
                    kode = Input.nextInt();
                    if (Curut.barang_exist(kode, max)) {
                      Curut.get_barang(kode);
                    }
                    else {
                      Catcher.message("NOTEXIST");
                    }
                 ...
                 break;
        case 3 : Curut.counter_barang = Curut.add_barang(max);
                 max = Curut.counter_barang;
                 break;
				default : break;
      }
  ...
  public static void main(String[] args) { //program utama
    ...
    do {
      ...
      switch (menu) {
        case 0 : exit = true; break;
        case 1 : Curut.menu_toko(); break;
        case 2 : Curut.menu_barang(Curut.counter_barang); break;
        case 3 : Curut.menu_konsumen(); break;
        case 4 : if (Curut.barang_available(Curut.counter_barang)) {
				        	 trx++; Curut.menu_belanja(trx, Curut.counter_barang);
				         }
				         else {
				         	 Catcher.message("NOTEXIST");Catcher.message("ADDDATA");
				        }
         				 break;
        case 5 : Curut.tentang(); break;
        default : break;
      }
